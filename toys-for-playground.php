...
add_filter("plugin_action_links_$plugin", 'toys_for_playground_add_settings_link');

// Register the plugin menu
add_action('admin_menu', 'toys_for_playground_plugin_menu');

function toys_for_playground_plugin_menu() {
    ...
    add_menu_page(
        ...
        'toys_for_playground_playground_page',    // Callback to render the page
    ...
    add_submenu_page(
        ...
        'toys_for_playground_cloner_page'          // Callback to render the page
    );
    ...
    add_submenu_page(
        ...
        'toys_for_playground_generator_page'       // Callback to render the page
    );
}

// Callback function for Playground page
function toys_for_playground_playground_page() {
    ?>
    <div class="wrap">
...
add_action('admin_footer', 'toys_for_playground_include_sharer_in_footer');  // For admin area


// Function shown by the Cloner toy
function toys_for_playground_cloner_page() {
...
function toys_for_playground_generator_page() {
...
function toys_for_playground_explorer_enqueue_scripts($hook) {
    ...
    wp_enqueue_script('toys-for-playground-explorer-script', plugin_dir_url(__FILE__) . 'plugin-explorer.js', array('jquery'), TOYSPG_VERSION, true);
}
...
function toys_for_playground_theme_explorer_enqueue_scripts($hook) {
    ...
    wp_enqueue_script('toys-for-playground-theme-explorer-script', plugin_dir_url(__FILE__) . 'theme-explorer.js', array('jquery'), TOYSPG_VERSION, true);
}
